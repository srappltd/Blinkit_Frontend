...
const Card = ({product}) => {
  return (
    <Link to={`/product-details?product=${product._id}`} key={product._id} className='card md:w-[15%] w-2/3 pb-3 border relative rounded-md overflow-hidden flex-shrink-0'>
