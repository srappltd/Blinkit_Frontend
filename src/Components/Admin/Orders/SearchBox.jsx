...
const SearchBox = ({printOrderTableHandler}) => {
  return (
    <div className='w-full flex justify-between items-center mt-3 md:text-sm text-xs'>
          ...
          <button onClick={printOrderTableHandler} className='w-28 border py-2 rounded border-red-300 font-medium hover:text-white hover:bg-red-500 gap-2 flex items-center justify-center'>
